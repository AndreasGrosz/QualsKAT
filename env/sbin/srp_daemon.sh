...
prog=/home/res/projekte/kd0241-py/Q-KAT/AAUNaL/Beta-v1.2/env/sbin/srp_daemon
params=("$@")
ibdir="/sys/class/infiniband"
rescan_interval=60
pids=()
pidfile="/home/res/projekte/kd0241-py/Q-KAT/AAUNaL/Beta-v1.2/env/var/run/srp_daemon.sh.pid"
mypid=$$
